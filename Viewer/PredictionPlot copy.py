...
class PredictionPlot(BasePlot):
    ...
    def prep_data(self, data):
        ...
        if len(data['switch']) != data['trace'].shape[1]:
...
if __name__ == "__main__":
    ...
    # dir = r"C:\Users\lepar\Documents\MSc\Phase_Recovery_UIs\Recovered_Data\20250115-SHG-FROG_ProbeAttWedge_1030nm_10fsStepSize"
